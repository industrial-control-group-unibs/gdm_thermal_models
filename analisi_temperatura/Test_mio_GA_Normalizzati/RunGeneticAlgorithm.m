...
%  ub     = [ inf inf inf inf inf inf inf inf inf];
 lb     = [ -10000 -10000 -10000 -10000 -10000 -10000 -10000 -10000];
 ub     = [ 10000 10000 10000 10000 10000 10000 10000 10000 10000];

%% Create Handle to Custom Output Function
custOutput = @(a1,a2,a3)ThOptimPlot(a1,a2,a3,tempi,Id_rms,Id,Iq_rms,Iq,vel_rms,vel,Pw_rms,Pws,T); %commentati i plot x velociz
